# QA Report — batch06_sk_en_y1 (Primary SK Y1 English Batch 06)

**Batch**: `batch06_sk_en_y1` (local Production batch number; published as `batch06.json`)
**Local Production Path**: `D:\Users\bajub\kuizku_p10\primary\batch06_sk_en_y1.json`
**Public Repo Path**: `banks\primary\sk\english\batch06.json`
**Date**: 2026-09-22
**Total Questions**: 100
**Curriculum**: KSSR
...
| Item | Value |
|---|---|
| **Local production SHA-256** | `2721579ba8ef58235e0734c40518477817b16118f0d3164124b0cfef7bb278e0` |
| **Local production file size** | 152,619 bytes |
| **Question ID range** | `sk-en-y1-351` to `sk-en-y1-450` |
...
- **File SHA-256**: `2721579ba8ef58235e0734c40518477817b16118f0d3164124b0cfef7bb278e0`
- **Source / local production batch**: `batch06_sk_en_y1.json` (D:\Users\bajub\kuizku_p10\primary\)
...
> **Local Production Source**: `D:\Users\bajub\kuizku_p10\primary\batch06_sk_en_y1.json` (SK Primary Year 1 English, KSSR curriculum).
>
> **Public Repo Publication**: This is the SIXTH batch published in `leonchoo/kuizku-content` EN primary path. Public repo adopts standardized naming `banks\<school>\<level>\<subject>\batchNN.json` sequential. Local B06 → public `batch06.json` (after batch01..batch05).
>
...
>
> **Cumulative originality verified against SK Primary Y1 EN local Production (B01 25 Qs + B02 25 Qs + B03 100 Qs + B04 100 Qs + B05 100 Qs = 350 Qs).** Zero ID overlap, zero subtopic overlap, zero exact-duplicate, zero near-duplicate. This batch contributes 100/100 NEW (subtopic, blueprintArchetype) pairs.
>
> **SK Primary Y1 English cumulative total after this Promotion: 450 questions (B01 25 + B02 25 + B03 100 + B04 100 + B05 100 + B06 100).**
