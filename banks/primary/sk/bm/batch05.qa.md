# QA Report — batch05_sk_bm_y1 (Primary SK Y1 BM Batch 05)

**Batch**: `batch05_sk_bm_y1` (local Production batch number; published as `batch05.json`)
**Local Production Path**: `D:\Users\bajub\kuizku_p10\batch05_sk_bm_y1.json`
**Public Repo Path**: `banks\primary\sk\bm\batch05.json`
**Date**: 2026-09-22
**Total Questions**: 100
**Curriculum**: KSSR
...
| Item | Value |
|---|---|
| **Local production SHA-256** | `a6fc8edde15936b03c66d546c3a5fadbbf10961fe21c98a0a1ef0ea7704993ef` |
| **Local production file size** | 150,721 bytes |
| **Question ID range** | `sk-bm-y1-251` to `sk-bm-y1-350` |
...
Topic distribution (8 topic labels):
  - Penulisan (Huruf): 4 Q
  - Penulisan (Perkataan): 5 Q
  - Penulisan (Ejaan): 3 Q
  - Penulisan (Ayat Mudah): 13 Q
  - Membaca: 30 Q
  - Tatabahasa: 20 Q
  - Perbendaharaan Kata: 15 Q
...
Context diversity: Sekolah, Rumah, Padang, Pasar, Taman, Kelas, Bilik darjah, Halaman, Dapur, Bengkel, Klinik, Ladang, Zoo (13 distinct contexts)
...
- **File SHA-256**: `a6fc8edde15936b03c66d546c3a5fadbbf10961fe21c98a0a1ef0ea7704993ef`
- **Source / local production batch**: `batch05_sk_bm_y1.json` (D:\Users\bajub\kuizku_p10\)
...
> **Local Production Source**: `D:\Users\bajub\kuizku_p10\batch05_sk_bm_y1.json` (SK Primary Year 1 Bahasa Melayu, KSSR curriculum).
>
> **Public Repo Publication**: This is the FIFTH batch published in `leonchoo/kuizku-content` BM primary path. Public repo adopts standardized naming `banks\<school>\<level>\<subject>\batchNN.json` sequential. Local B05 → public `batch05.json` (after batch01 = Local B01, batch02 = Local B02, batch03 = Local B03, batch04 = Local B04).
>
...
>
> **Cumulative originality verified against SK Primary Y1 BM local Production (B01 25 Qs + B02 25 Qs + B03 100 Qs + B04 100 Qs = 250 Qs).** Zero ID overlap, zero subtopic overlap, zero exact-duplicate, zero near-duplicate. This batch contributes 100/100 NEW (subtopic, blueprintArchetype) pairs.
>
> **SK Primary Y1 BM cumulative total after this Promotion: 350 questions (B01 25 + B02 25 + B03 100 + B04 100 + B05 100).**
