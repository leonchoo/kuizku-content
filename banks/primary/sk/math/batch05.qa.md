# QA Report — batch_secondary_09_sk_math_y1 (Primary SK Y1 Math Batch 09)

**Batch**: `batch_secondary_09_sk_math_y1` (local Production batch number; published as `batch05.json`)
**Local Production Path**: `D:\Users\bajub\kuizku_p10\primary\batch09_sk_math_y1.json`
**Public Repo Path**: `banks\primary\sk\math\batch05.json`
**Date**: 2026-09-22
**Total Questions**: 100
**Curriculum**: KSSR
...
| Item | Value |
|---|---|
| **Local production SHA-256** | `36af8b3b32ba8ce6f7df2f238cb97ec38254bde00b47fe82b4f196ff7d304d4b` |
| **Local production file size** | 107,478 bytes |
| **Question ID range** | `v5-sk-math-y1-501` to `v5-sk-math-y1-600` |
...
Context diversity: Sekolah, Rumah, Pasar, Dapur, Taman, Padang, Perpustakaan, Hospital
...
✅ PASS: Cross-batch exact duplicates vs B02-B03-B04-B05-B06-B07-B08 — 0
✅ PASS: Cross-batch semantic near-duplicates — 0
✅ PASS: No subtopic overlap with B02-B08 — 0 shared subtopics
✅ PASS: No ID overlap with B02-B08 — 0
...
- **File SHA-256**: `36af8b3b32ba8ce6f7df2f238cb97ec38254bde00b47fe82b4f196ff7d304d4b`
- **Source / local production batch**: `batch09_sk_math_y1.json` (D:\Users\bajub\kuizku_p10\primary\)
...
- Exact duplicates (vs B02-B08): **0**
- Near duplicates (within batch): **0**
- Near duplicates (vs B02-B08): **0**
- Subtopic overlap (vs B02-B08): **0**
...
✅ **BATCH 09 QA PASS — ALL 100 QUESTIONS PASS**

---

## Source Provenance Statement (REQUIRED)

> **Local Production Source**: `D:\Users\bajub\kuizku_p10\primary\batch09_sk_math_y1.json` (SK Primary Year 1 Mathematics, KSSR curriculum).
>
> **Public Repo Publication**: This is the fifth Math batch published in `leonchoo/kuizku-content` (after `batch01.json` = local B05, `batch02.json` = local B06, `batch03.json` = local B07, `batch04.json` = local B08). The public repo adopts the standardized naming convention `banks\<school>\<level>\<subject>\batchNN.json` (sequential numbering), so this fifth batch is published as `batch05.json`.
>
...
>
> **Cumulative originality verified against SK Primary Y1 Math local Production (B02 20 Qs + B03 25 Qs + B04 25 Qs + B05 100 Qs + B06 100 Qs + B07 100 Qs + B08 100 Qs = 470 Qs total).** Zero ID overlap, zero subtopic overlap, zero exact-duplicate, zero near-duplicate. This batch contributes 100/100 NEW (subtopic, blueprintArchetype) pairs.
>
> **SK Primary Y1 Math cumulative total after this Promotion: 570 questions (B02 20 + B03 25 + B04 25 + B05 100 + B06 100 + B07 100 + B08 100 + B09 100).**
