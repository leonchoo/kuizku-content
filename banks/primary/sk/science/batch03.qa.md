# QA Report — batch03_sk_science_y1 (Primary SK Y1 Science Batch 03)

**Batch**: `batch03_sk_science_y1` (local Production batch number; published as `batch03.json`)
**Local Production Path**: `D:\Users\bajub\kuizku_p10\primary\batch03_sk_science_y1.json`
**Public Repo Path**: `banks\primary\sk\science\batch03.json`
**Date**: 2026-09-23
**Total Questions**: 100
**Curriculum**: KSSR
...
**Language**: ms (Bahasa Malaysia — matches B01/B02)
...
| Item | Value |
|---|---|
| **Local production SHA-256** | `c66a882bf17f2404bccd321a1d3529d76603990d3d1d727d87c22bc8f29d54c1` |
| **Local production file size** | 154,690 bytes |
| **Question ID range** | `***` to `***` (sk-science-y1-151..250) |
...
Difficulty distribution (target 60/30/10 per B01/B02 canonical):
  - Easy (diff=1): 60 Q
  - Medium (diff=2): 30 Q
  - Hard (diff=3): 10 Q
✅ PASS: Difficulty matches Plan — ✅ exact

Topic distribution (7 topic labels, matches B02):
  - Haiwan: 20 Q
  - Tumbuhan: 12 Q
  - Bahan: 16 Q
  - Pergerakan: 10 Q
...
Skill distribution (target 46/26/28 per B01/B02 canonical):
  - RECOGNITION: 46 Q
  - COMPREHENSION: 26 Q
  - APPLICATION: 28 Q
...
- **File SHA-256**: `c66a882bf17f2404bccd321a1d3529d76603990d3d1d727d87c22bc8f29d54c1`
- **Source / local production batch**: `batch03_sk_science_y1.json` (D:\Users\bajub\kuizku_p10\primary\)
...
> **Local Production Source**: `D:\Users\bajub\kuizku_p10\primary\batch03_sk_science_y1.json` (SK Primary Year 1 Science, KSSR curriculum, Malay medium).
>
> **Public Repo Publication**: This is the THIRD batch published in `leonchoo/kuizku-content` Science primary path. Public repo adopts standardized naming `banks\<school>\<level>\<subject>\batchNN.json` sequential. Local B03 → public `batch03.json` (after batch01..batch02; though batch01 was local only).
>
...
>
> **Cumulative originality verified against SK Primary Y1 Science local Production (B01 50 Qs + B02 100 Qs = 150 Qs).** Zero ID overlap, zero subtopic overlap, zero exact-duplicate, zero near-duplicate. This batch contributes 100/100 NEW (subtopic, blueprintArchetype) pairs.
>
> **SK Primary Y1 Science cumulative total after this Promotion: 250 questions (B01 50 + B02 100 + B03 100).**
